...
description: >
  Add a new Zworker issue-thread interaction kind end-to-end. Use when repo
...
Developer/maintainer skill. Do NOT install this on production Zworker agents.

This skill walks a Zworker contributor through introducing a new issue-thread
...
the operational agents that run inside a deployed Zworker company.

Do NOT install this on production Zworker agents. This guide is for repository contributors changing Zworker itself.
...
- Changing how Zworker agents *call* interactions. Update `skills/paperclip`
...
your own plan document if you are running this work through Zworker itself.
