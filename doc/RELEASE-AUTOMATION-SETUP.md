...
This document covers the GitHub and npm setup required for the current Zworker release model:
...
Do this for every public package that Zworker publishes.
...
2. revoke any personal automation token that used to publish Zworker
