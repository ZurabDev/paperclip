...
This is intentionally separate from the normal Zworker dev image.
...
## Preview the Zworker app from the PR
...
- Zworker's embedded PostgreSQL and local storage stay inside the container home volume via `PAPERCLIP_HOME=/home/reviewer/.paperclip-review`.
