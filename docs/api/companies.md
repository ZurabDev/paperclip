...
Manage companies within your Zworker instance.
...
Company logo uploads use the normal Zworker attachment size limit.
...
| `logoUrl` | string | Optional Zworker asset content path for the stored logo image |
