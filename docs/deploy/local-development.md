...
summary: Set up Zworker for local development
---

Run Zworker locally with zero external dependencies.
...
No Docker or external database required. Zworker uses embedded PostgreSQL automatically.
...
To open Zworker to a private network with login enabled:
