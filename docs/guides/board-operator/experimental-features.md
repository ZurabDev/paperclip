...
summary: What Zworker experimental features mean for board operators
---
...
When a feature is marked experimental, Zworker is still evaluating the product shape and implementation details.
...
- Zworker does not promise compatibility, rollback, migration, or long-term support for experimental features.
