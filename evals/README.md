...
Eval framework for testing Zworker agent behaviors across models and prompt versions.
...
Phase 0 covers narrow behavior evals for the Zworker heartbeat skill:
