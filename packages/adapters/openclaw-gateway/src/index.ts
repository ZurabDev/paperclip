...
Use when:
- You want Zworker to invoke OpenClaw over the Gateway WebSocket protocol.
...
- Your deployment does not permit outbound WebSocket access from the Zworker server.
...
- paperclipApiUrl (string, optional): absolute Zworker base URL advertised in wake text
...
Wake payload notes:
- Zworker wake context is embedded into the generated message text
