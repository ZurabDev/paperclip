...
Model Context Protocol server for Zworker.

This package is a thin MCP wrapper over the existing Zworker REST API. It does
...
- `PAPERCLIP_API_URL` - Zworker base URL, for example `http://localhost:3100`
