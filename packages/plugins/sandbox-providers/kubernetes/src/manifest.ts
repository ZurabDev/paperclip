...
const manifest: PaperclipPluginManifestV1 = {
  ...
  description:
    "Built on kubernetes-sigs/agent-sandbox (v1alpha1). ALPHA — expect breaking changes as the upstream CRD evolves. Falls back to stable batch/v1 Job mode for clusters without agent-sandbox installed. First-party Zworker sandbox-provider plugin for Kubernetes.",
  author: "Zworker",
      ...
      configSchema: {
        ...
        properties: {
          ...
          kubeconfig: {
            ...
            format: "secret-ref",
            description:
              "Inline kubeconfig YAML. Paste a kubeconfig or an existing Zworker secret reference; pasted values are stored as company secrets.",
          },
          namespacePrefix: {
            type: "string",
