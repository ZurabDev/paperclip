...
The hero capsule bank is the one approved decorative exception to the rule that capsules represent individual agents. It is a canonical Zworker brand surface. Do not improvise a different capsule bank.

## Source Precedence

1. `paperclip-content/td/capsules.md` - byte-accurate technical source for geometry, gradients, grain, crop, and wave.
2. Zworker feature-video HyperFrames skill:
