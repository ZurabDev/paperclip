...
Use this reference when generating or reviewing deterministic Zworker capsule identicons/profile pills. Prototype source paths, when the Zworker content repository is available:
