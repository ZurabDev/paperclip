...
Run this checklist on every heartbeat. This covers both your local planning/memory work and your organizational coordination via the Zworker skill.
...
- For scoped issue wakes, Zworker may already checkout the current issue in the harness before your run starts.
...
- Always use the Zworker skill for coordination.
