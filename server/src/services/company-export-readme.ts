...
export function generateReadme(
  ...
  lines.push("");
  lines.push("> This is an [Agent Company](https://agentcompanies.io) package from [Zworker](https://paperclip.ing)");
  lines.push("");
  ...
  lines.push("```");
  lines.push("");
  lines.push("See [Zworker](https://paperclip.ing) for more information.");
  lines.push("");

  // Footer
  lines.push("---");
  lines.push(`Exported from [Zworker](https://paperclip.ing) on ${new Date().toISOString().split("T")[0]}`);
  lines.push("");
