...
- [ ] The first paragraph points at the Zworker skill as the source of truth for the heartbeat procedure
...
- [ ] For execution-heavy roles (coders, operators, designers, security, QA), `AGENTS.md` includes the Zworker execution contract verbatim:
...
- [ ] Adapter config matches this Zworker instance (cwd, model, credentials) per `/llms/agent-configuration/<adapter>.txt`
