...
const mockCompanyState = vi.hoisted(() => ({
  companies: [{ id: "company-1", issuePrefix: "PAP", name: "Zworker" }],
  selectedCompany: { id: "company-1", issuePrefix: "PAP", name: "Zworker" },
...
describe("Layout", () => {
  ...
  beforeEach(() => {
    ...
    mockCompanyState.companies = [{ id: "company-1", issuePrefix: "PAP", name: "Zworker" }];
    mockCompanyState.selectedCompany = { id: "company-1", issuePrefix: "PAP", name: "Zworker" };
  ...
  it("uses the route company context for plugin route sidebars on the first render", async () => {
    ...
    mockCompanyState.companies = [
      { id: "company-1", issuePrefix: "PAP", name: "Zworker" },
