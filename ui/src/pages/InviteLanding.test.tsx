...
vi.mock("../api/auth", () => ({
  authApi: {
    ...
    signUpEmail: (input: unknown, inviteToken?: string) => signUpEmailMock(input, inviteToken),
  },
}));
...
describe("InviteLandingPage", () => {
  ...
  it("defaults invite auth to account creation and guides existing users back to sign in", async () => {
    ...
    expect(container.textContent).toContain("You've been invited to join Zworker");
