...
const MATERIALIZATION_NOTE =
  "Enabled skills are materialized into the stable Zworker-managed prompt bundle on the agent's next run.";
...
export function AgentSkillsTab({ agent, companyId }: { agent: Agent; companyId?: string }) {
  ...
  const unsupportedMessage = useMemo(() => {
    ...
    if (
      ...
      return "Zworker cannot manage skills for custom ACP commands yet.";
    }
    if (agent.adapterType === "openclaw_gateway") {
      return "Zworker cannot manage OpenClaw skills here. Visit your OpenClaw instance to manage this agent's skills.";
    }
    return "Zworker cannot manage skills for this adapter yet. Manage them in the adapter directly.";
