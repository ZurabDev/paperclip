        ...
        drafts: [
          {
            ...
            warnings: ["Header Authorization will be stored as a Zworker secret before activation."],
          },
        ],
      },
        ...
        drafts: [
          {
            ...
            credentialFields: [],
            warnings: ["Imported stdio commands stay draft-only unless mapped to an approved Zworker template."],
          },
        ],
      },
